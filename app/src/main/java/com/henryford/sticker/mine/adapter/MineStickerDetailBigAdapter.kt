...
class MineStickerDetailBigAdapter :BaseAdapter<MineStickerBean.InnerMineStickerBean,MineStickerDetailBigAdapter.ViewHolder>{
    val TAG = MineStickerDetailBigAdapter::class.java.simpleName
    constructor() : super()
    ...
    override fun onStickerCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        var view = LayoutInflater.from(parent.context).inflate(R.layout.item_mine_sticker_detail_big,parent,false)
